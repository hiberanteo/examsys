...
public class SubjectDAOImpl implements SubjectDAO{
	...
	public List<Subject> randomFindSubject(int number,String typeName) {
		Session session = HibernateSessionFactory.getSession();//获得Session对象
		Query query = session.createQuery("from Subject as sub where sub.typeName =? order by rand()");
	...
	public List<Subject> randomFindSubject(int number,int id) {
		Session session = HibernateSessionFactory.getSession();//获得Session对象
		Query query = session.createQuery("from Subject as sub where sub.subjectType =? order by rand()");
